...
import type { User, Chat, ChatMessage, Transaction } from "@shared/types";
import { MOCK_CHAT_MESSAGES, MOCK_CHATS, MOCK_USERS, MOCK_TRANSACTIONS } from "@shared/mock-data";
